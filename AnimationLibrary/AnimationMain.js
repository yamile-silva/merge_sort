...
{
	stepForwardButton.disabled = false;//BOTON PASO ADELANTE
	if (skipBackButton.disabled == false)
	{
		stepBackButton.disabled = false;
	}
	objectManager.statusReport.setText("ANIMACION EN PAUSA");
...
function animStarted()
{
	...
	objectManager.statusReport.setText("ANIMACION EN CURSO");
...
function initCanvas()
{
	...
	skipBackButton = addControlToAnimationBar("Button", "VOLVER AL INICIO");
	...
	skipForwardButton = addControlToAnimationBar("Button", "FINAL");
	...
	var txtNode = document.createTextNode("VELOCIDAD"); 
	midLevel.appendChild(bottomLevel);
	...
	txtNode = document.createTextNode("ANCHO:"); 
	...
	tableEntry = document.createElement("td");
	txtNode = document.createTextNode("LARGO:"); 
	tableEntry.appendChild(txtNode);
	controlBar.appendChild(tableEntry);
...
//	heightEntry.size = 4;
	sizeButton = addControlToAnimationBar("Button", "APLICAR");
